...
//                 // Cette fonction retourne le tableau des ipes de tous les centre
        ...
        serverRequest: function(post_data) {
            ...
            $http({
                method: 'POST',
                url: "http://41.205.8.159/IpesServeur/client-controleur/cont_affiche_ipes.php",
        ...
        serverRequest1: function(post_data) {
            ...
            $http({
                method: 'POST',
                url: "http://41.205.8.159/IpesServeur/client-controleur/cont_affiche_ipes_all.php",
                data: {'region': post_data}
       ...
       //  liste les annonce par centre et ipes  
        serverRequest2: function(post_data) {
            ...
            $http({
                method: 'POST',
                url: "http://41.205.8.159/IpesServeur/client-controleur/cont_affiche_ipes_annonce.php",
                data: {'region': post_data}
            }).success(function(data)
            {

...
ipescam.factory('service_Add_adresse_ipes', function($q,$http) {
	...
	return {
		...
		serverRequest : function(data_adresse_ipes,$scope){
			 ...
			 $http({
				 method: 'POST', 
				 url: "http://41.205.8.159/web/IpesServeur/client-controleur/cont_ajouter_adresse_ipes.php",
		...
		serverRequest1 : function(data_quartier_ipes,$scope){
			 ...
			 $http({
				 method: 'POST', 
				 url: "http://41.205.8.159/web/IpesServeur/client-controleur/cont_ajouter_quartier_ipes.php",
